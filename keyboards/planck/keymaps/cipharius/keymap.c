...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, BACKLIT, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_RSFT, KC_RCTL
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, KC_PIPE,
    _______, KC_LBRC, KC_RBRC, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,   _______, _______,
